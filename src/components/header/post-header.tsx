    ...
    return (
        <Toolbar disableGutters={true}>
            <Link to={config.siteUrl} color="inherit" className={classes.link} >
                <IconButton edge="start" color="inherit" aria-label="Logo" className={classes.iconButton}>
    ...
    return (
        <>
            <Paper color="primary" className={classes.headerBoard} square={true} elevation={0}>
                <Container>
                    <SocialTab classes={classes} socials={socials} toggleDrawer={toggleDrawer}><LinksTab  classes={classes} list={list}/></SocialTab>
                </Container>
            </Paper>
        </>
    )
    ...
    return (
        <div className={classes.root}>
            <HideOnScroll {...props}>
                <AppBar elevation={0}>
                    <Container>
                        <SocialTab classes={classes} socials={socials} toggleDrawer={toggleDrawer}><LinksTab  classes={classes} list={categories}/></SocialTab>
                    </Container>
                </AppBar>
            </HideOnScroll>
